				...
				<form name="form" class="form-horizontal" method="post"
					...
					<div class="form-group">
						<label for="inputPassword3" class="col-xs-2 control-label">생년
							...
							style="width: 100px;">
								<option value="${requestScope.dto.birth}">${requestScope.dto.birth}</option>
					...
					<div class="form-group">
						...
						<div class="col-sm-2" style="width: 100px;">
							...
							<select class="form-control" name="grade" style="width: 100px;">
								<option value="${requestScope.dto.grade}">${requestScope.dto.grade}</option>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input class="btn btn-default " type="file" name="img" size="50"
								maxlength="100" value="${requestScope.dto.img}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2" style="width: 80px;">
							...
							<select class="form-control" name="job">
								<option value="${requestScope.dto.job}">${requestScope.dto.job}</option>
					...
					<div class="form-group">
						...
						<div class="col-xs-5">
							<input type="text" class="form-control" id="company"
								name="company" value="${requestScope.dto.company}">
						</div>
					</div>
